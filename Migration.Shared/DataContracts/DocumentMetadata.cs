...
{
    public class DocumentMetadata : Resource, IDynamicMetaObjectProvider
    {
        /// <summary>
        ...
        public int? TimeToLive
        {
            ...
            set => base.SetValue("ttl", value);
        }

        //Helper to materialize Document from any .NET object.
        internal static DocumentMetadata FromObject(object document, JsonSerializerSettings settings = null)
        {
            if (document != null)
            {
                if (typeof(DocumentMetadata).IsAssignableFrom(document.GetType()))
                {
                ...
                else
                {
                    ...
                    DocumentMetadata typeDocument = new DocumentMetadata() { SerializerSettings = settings };
        ...
        {
            if (typeof(T) == typeof(DocumentMetadata) || typeof(T) == typeof(object))
            {
        ...
        private class DocumentDynamicMetaObject : DynamicMetaObject
        {
            ...
            public override DynamicMetaObject BindGetMember(GetMemberBinder binder)
            {
                ...
                Expression getPropertyExpression = Expression.Call(
                    thisExpression,
                    typeof(DocumentMetadata).GetMethod(methodName, BindingFlags.NonPublic | BindingFlags.Instance),
                    parameters);
            ...
            public override DynamicMetaObject BindConvert(ConvertBinder binder)
            {
                ...
                MethodCallExpression methodExpression = Expression.Call(
                    self,
                    typeof(DocumentMetadata).GetMethod("AsType",
